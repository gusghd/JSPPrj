...
<header id="header">
	<div class="content-wrapper">
		<h1 id="logo">
			<a href="${ ctxName}/index.html"><img src="${ ctxName}/images/logo.png" alt="뉴렉처 온라인" /></a>
		</h1>
			...
			<nav id="member-menu">
				...
				<ul class="clearfix">
					<li class="member-menu-item"><a class="member-menu-item-text"
						href="ctxName/index.html">홈</a></li>
					<li class="member-menu-item"><c:if test="${uid == null}">
					...
					<li class="member-menu-item"><a class="member-menu-item-text"
						href="${ ctxName}/joinus/join.html">회원가입</a></li>
				</ul>
			</nav>
			...
			<nav id="my-menu">
				...
				<ul class="clearfix">
					<li class="my-menu-item"><a class="my-menu-item-text" href=""><img
							src="${ ctxName}/images/txt-mypage.png" alt="마이페이지" /></a></li>
					<li class="my-menu-item"><a class="my-menu-item-text"
						href="customer/notice.jsp"><img src="${ ctxName}/images/txt-customer.png"
							alt="고객센터" /></a></li>
				</ul>
			</nav>
		</section>
